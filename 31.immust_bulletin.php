<html>
    ...
    // 啟動FlexSlider，設定動畫效果為滑動，從右到左(rtl: true)
    ...
    /* 頂部 container 使用 Flexbox 置中與左右分散 */
        .top .container{
            display: flex;
            align-items: center;
